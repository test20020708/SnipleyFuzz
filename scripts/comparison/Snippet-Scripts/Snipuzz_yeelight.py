...
def info():
    ...
    while(1):
        ...
        if len(number_array) != 0:
            ...
            average = 0 
        with open(os.path.join('./scripts/comparison/share', 'Snipuzz_yeelight.txt'), 'w') as f:
...
def writeOutput(seed):
    ...
    file = 'snipuzz_yeelight-Crash-' + str(crash_number) + ":" + localtime + '.txt'
