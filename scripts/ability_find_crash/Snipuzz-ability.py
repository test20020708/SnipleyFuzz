...
python_file = ["./Fuzzing/Snipuzz-py/Snipuzz_xiaomi_camera.py",
               "./Fuzzing/Snipuzz-py/Snipuzz_xiaomi_plug.py",
               "./Fuzzing/Snipuzz-py/Snipuzz_yeelight.py"]
stop_flag = False
start_time = 0
crash_time = {}
    ...
    while(1):
        for file in python_file:
            ...
            if crash_number != 0:
                ...
                crash_time[file.split("/")[-1].split(".")[0]] = finish_time - start_time    
