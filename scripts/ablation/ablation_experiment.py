...
# List of Python files to execute in parallel(three groups)
python_files_first_round = ["./scripts/ablation/IoTFuzzing-Adv/IoTFuzz_yeelight.py",
...
python_files_second_round = ["./scripts/ablation/IoTFuzzing-Adv/IoTFuzz_xiaomi_camera.py",
...
python_files_third_round = ["./scripts/ablation/IoTFuzzing-Adv/IoTFuzz_xiaomi_plug.py",
