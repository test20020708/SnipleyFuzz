...
def info():
    ...
    while(1):
        ...
        if len(number_array) != 0:
            ...
            average = 0 
        with open(os.path.join('./scripts/ablation/share', 'yeelight-M-SN.txt'), 'w') as f:
...
def writeOutput(seed):
    ...
    file = 'yeelight-M-SN-Crash-' + str(crash_number) + ":" + localtime + '.txt'
...
def advanced_mutate(queue, restoreSeed):
    ...
    # randomly selecting the segments
    snippet_index_array = []
